				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addComponent(txtCusersloyindownloadsmydocumentation, GroupLayout.PREFERRED_SIZE, 319, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
									...
									.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
										.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
											.addComponent(txtpnSelectTemplate, GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
											.addComponent(editorPane, GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))
										.addPreferredGap(ComponentPlacement.RELATED)))
								.addGroup(gl_contentPane.createSequentialGroup()
